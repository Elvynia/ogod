...
export interface OgodRuntimeContainer<S extends OgodStateContainer<C>, A extends OgodActionReactive<S>, C extends keyof OgodCategoryState = S['category']> extends OgodRuntimeReactive<S, A> {
